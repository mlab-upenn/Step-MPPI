...
from step_mppi.dmppi_trainer import DMPPI_Trainer
...
def main():
    ...
    print(
        ...
        f"freeze_policy={trainer.freeze_policy}"
    )
    ...
    if retrain_path is not None:
        ...
        if trainer.freeze_policy:
            optimizer_state = None
            print("Freezing distribution policy for retraining: resetting optimizer state to train updater only.")
